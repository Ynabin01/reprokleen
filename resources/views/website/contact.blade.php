            ...
            <div class="row">
                <div class="col-12">
                    <div class="subheader-content">
                        <h1 class="page-title text-white fw-300"> @php echo $normal->caption; @endphp</h1>
            ...
            <div class="clearfix main-content no-gutters row">
                ...
                <div class="col-lg-7 col-12">
                    <div class="form-wrapper">
                        <form action="http://html.creativegigs.net/charles/inc/sendemail.php"
                            class="theme-form-one form-validation" autocomplete="off">
                            <div class="row">
